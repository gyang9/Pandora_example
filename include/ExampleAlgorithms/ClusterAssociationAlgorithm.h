/**
 *  @file   ExampleAlgorithms/ClusterAssociationAlgorithm.h
 * 
 *  @brief  Header file for the cluster association algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_ASSOCIATION_ALGORITHM_H
#define EXAMPLE_CLUSTER_ASSOCIATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CLUSTER_ASSOCIATION_ALGORITHM_H
