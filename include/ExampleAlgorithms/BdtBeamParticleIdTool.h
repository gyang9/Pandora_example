/**
 *  @file   ExampleAlgorithms/BdtBeamParticleIdTool.h
 *
 *  @brief  Header file for the beam particle id tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_BDT_BEAM_PARTICLE_ID_TOOL_H
#define EXAMPLE_BDT_BEAM_PARTICLE_ID_TOOL_H 1

#include "ExampleAlgorithms/MasterAlgorithm.h"

#include "ExampleAlgorithms/LArMvaHelper.h"

#include "ExampleAlgorithms/LArAdaBoostDecisionTree.h"
...
#endif // #ifndef EXAMPLE_BDT_BEAM_PARTICLE_ID_TOOL_H
