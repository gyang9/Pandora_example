/**
 *  @file   ExampleAlgorithms/ClusterSplittingAlgorithm.h
 *
 *  @brief  Header file for the cluster splitting algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_SPLITTING_ALGORITHM_H
#define EXAMPLE_CLUSTER_SPLITTING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CLUSTER_SPLITTING_ALGORITHM_H
