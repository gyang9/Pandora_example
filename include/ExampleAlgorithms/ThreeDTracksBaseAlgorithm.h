/**
 *  @file   ExampleAlgorithms/ThreeDTracksBaseAlgorithm.h
 * 
 *  @brief  Header file for the three dimensional tracks algorithm base class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_THREE_D_TRACKS_BASE_ALGORITHM_H
#define EXAMPLE_THREE_D_TRACKS_BASE_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_THREE_D_TRACKS_BASE_ALGORITHM_H
