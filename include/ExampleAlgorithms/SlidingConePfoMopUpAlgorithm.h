/**
 *  @file   ExampleAlgorithms/SlidingConePfoMopUpAlgorithm.h
 * 
 *  @brief  Header file for the sliding cone pfo mop up algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_SLIDING_CONE_PFO_MOP_UP_ALGORITHM_H
#define EXAMPLE_SLIDING_CONE_PFO_MOP_UP_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_SLIDING_CONE_PFO_MOP_UP_ALGORITHM_H
