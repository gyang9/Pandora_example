/**
 *  @file   ExampleAlgorithms/LArParticleIdPlugins.h
 * 
 *  @brief  Header file for the lar particle id plugins class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_PARTICLE_ID_PLUGINS_H
#define EXAMPLE_PARTICLE_ID_PLUGINS_H 1
...
#endif // #ifndef EXAMPLE_PARTICLE_ID_PLUGINS_H
