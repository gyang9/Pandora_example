/**
 *  @file   ExampleAlgorithms/ThreeDTrackFragmentsAlgorithm.h
 *
 *  @brief  Header file for the three dimensional fragments algorithm base class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_THREE_D_TRACK_FRAGMENTS_ALGORITHM_H
#define EXAMPLE_THREE_D_TRACK_FRAGMENTS_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_THREE_D_TRACK_FRAGMENTS_ALGORITHM_H
