/**
 *  @file   ExampleAlgorithms/ThreeDTransverseTracksAlgorithm.h
 *
 *  @brief  Header file for the three dimensional transverse tracks algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_THREE_D_TRANSVERSE_TRACKS_ALGORITHM_H
#define EXAMPLE_THREE_D_TRANSVERSE_TRACKS_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_THREE_D_TRANSVERSE_TRACKS_ALGORITHM_H
