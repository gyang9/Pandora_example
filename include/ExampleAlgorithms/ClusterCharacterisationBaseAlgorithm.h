/**
 *  @file   ExampleAlgorithms/ClusterCharacterisationBaseAlgorithm.h
 *
 *  @brief  Header file for the cluster characterisation base algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_CHARACTERISATION_BASE_ALGORITHM_H
#define EXAMPLE_CLUSTER_CHARACTERISATION_BASE_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CLUSTER_CHARACTERISATION_BASE_ALGORITHM_H
