/**
 *  @file   ExampleAlgorithms/CandidateVertexCreationAlgorithm.h
 * 
 *  @brief  Header file for the candidate vertex creation algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_CANDIDATE_VERTEX_CREATION_ALGORITHM_H
#define EXAMPLE_CANDIDATE_VERTEX_CREATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CANDIDATE_VERTEX_CREATION_ALGORITHM_H
