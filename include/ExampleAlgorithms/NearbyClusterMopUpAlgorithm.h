 ...
 *  $Log: $
 */
#ifndef EXAMPLE_NEARBY_CLUSTER_MOP_UP_ALGORITHM_H
#define EXAMPLE_NEARBY_CLUSTER_MOP_UP_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_NEARBY_CLUSTER_MOP_UP_ALGORITHM_H
