/**
 *  @file   ExampleAlgorithms/TrackShowerIdFeatureTool.h
 *
 *  @brief  Header file for the track shower id feature tools
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TRACK_SHOWER_ID_FEATURE_TOOLS_H
#define EXAMPLE_TRACK_SHOWER_ID_FEATURE_TOOLS_H 1
...
#endif // #ifndef EXAMPLE_TRACK_SHOWER_ID_FEATURE_TOOLS_H
