/**
 *  @file   ExampleAlgorithms/DeltaRayMatchingAlgorithm.h
 *
 *  @brief  Header file for the delta ray matching algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_DELTA_RAY_MATCHING_ALGORITHM_H
#define EXAMPLE_DELTA_RAY_MATCHING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_DELTA_RAY_MATCHING_ALGORITHM_H
