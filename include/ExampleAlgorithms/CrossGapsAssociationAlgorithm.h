/**
 *  @file   ExampleAlgorithms/CrossGapsAssociationAlgorithm.h
 *
 *  @brief  Header file for the cross gaps association algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CROSS_GAPS_ASSOCIATION_ALGORITHM_H
#define EXAMPLE_CROSS_GAPS_ASSOCIATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CROSS_GAPS_ASSOCIATION_ALGORITHM_H
