/**
 *  @file   ExampleAlgorithms/HitCreationBaseTool.h
 *
 *  @brief  Header file for the hit creation base tool.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_HIT_CREATION_BASE_TOOL_H
#define EXAMPLE_HIT_CREATION_BASE_TOOL_H 1
...
#endif // #ifndef EXAMPLE_HIT_CREATION_BASE_TOOL_H
