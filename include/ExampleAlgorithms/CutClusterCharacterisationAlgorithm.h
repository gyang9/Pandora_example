/**
 *  @file   ExampleAlgorithms/CutClusterCharacterisationAlgorithm.h
 *
 *  @brief  Header file for the cut based cluster characterisation algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CUT_CLUSTER_CHARACTERISATION_ALGORITHM_H
#define EXAMPLE_CUT_CLUSTER_CHARACTERISATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CUT_CLUSTER_CHARACTERISATION_ALGORITHM_H
