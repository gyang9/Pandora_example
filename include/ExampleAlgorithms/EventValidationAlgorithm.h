/**
 *  @file   ExampleAlgorithms/EventValidationAlgorithm.h
 *
 *  @brief  Header file for the event validation algorithm.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_EVENT_VALIDATION_ALGORITHM_H
#define EXAMPLE_EVENT_VALIDATION_ALGORITHM_H 1
...
#endif // EXAMPLE_EVENT_VALIDATION_ALGORITHM_H
