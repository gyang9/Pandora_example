/**
 *  @file   ExampleAlgorithms/CubeTwoDSlidingFitObjects.h
 *
 *  @brief  Header file for the lar two dimensional sliding fit objects.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TWO_D_SLIDING_FIT_OBJECTS_H
#define EXAMPLE_TWO_D_SLIDING_FIT_OBJECTS_H 1
...
#endif // #ifndef EXAMPLE_TWO_D_SLIDING_FIT_OBJECTS_H
