/**
 *  @file   ExampleAlgorithms/CubeClusterHelper.h
 *
 *  @brief  Header file for the cluster helper class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_HELPER_H
#define EXAMPLE_CLUSTER_HELPER_H 1
...
/**
 *  @brief  CubeClusterHelper class
 */
class CubeClusterHelper
{
public:
    /**
  ...
  /**
    ...
    static void GetClusterSpanY(const pandora::Cluster *const pCluster, float &xmin, float &xmax);

    static void GetClusterSpanZ(const pandora::Cluster *const pCluster, float &xmin, float &xmax);
