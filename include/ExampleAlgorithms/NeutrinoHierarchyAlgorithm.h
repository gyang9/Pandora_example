/**
 *  @file   ExampleAlgorithms/NeutrinoHierarchyAlgorithm.h
 * 
 *  @brief  Header file for the neutrino hierarchy algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_NEUTRINO_HIERARCHY_ALGORITHM_H
#define EXAMPLE_NEUTRINO_HIERARCHY_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_NEUTRINO_HIERARCHY_ALGORITHM_H
