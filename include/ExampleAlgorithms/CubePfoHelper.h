/**
 *  @file   ExampleAlgorithms/CubePfoHelper.h
 *
 *  @brief  Header file for the pfo helper class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_PFO_HELPER_H
#define EXAMPLE_PFO_HELPER_H 1
...
public:
    ...
    static void GetSlidingFitTrajectory(const pandora::CartesianPointVector &pointVector, const pandora::CartesianVector &vertexPosition,
        const unsigned int layerWindow, const float layerPitch, CubeTrackStateVector &trackStateVector, pandora::IntVector *const pIndexVector = nullptr);
    ...
    static void GetSlidingFitTrajectory(const pandora::ParticleFlowObject *const pPfo, const pandora::Vertex *const pVertex,
        const unsigned int slidingFitHalfWindow, const float layerPitch, CubeTrackStateVector &trackStateVector);
     ...
     *  @param  vertexPosition the input vertex position
     */
    static CubeShowerPCA GetPrincipalComponents(const pandora::CartesianPointVector &pointVector, const pandora::CartesianVector &vertexPosition);
     ...
     *  @param  pVertex the address of the input vertex
     */
    static CubeShowerPCA GetPrincipalComponents(const pandora::ParticleFlowObject *const pPfo, const pandora::Vertex *const pVertex);
     ...
     */
    static bool SortByHitProjection(const CubeTrackTrajectoryPoint &lhs, const CubeTrackTrajectoryPoint &rhs);
...
private:
    ...
    static void SlidingFitTrajectoryImpl(const T *const pT, const pandora::CartesianVector &vertexPosition, const unsigned int layerWindow,
        const float layerPitch, CubeTrackStateVector &trackStateVector, pandora::IntVector *const pIndexVector = nullptr);
};

} // namespace example_content

#endif // #ifndef EXAMPLE_PFO_HELPER_H
