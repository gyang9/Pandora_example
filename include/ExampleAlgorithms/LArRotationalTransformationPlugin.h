/**
 *  @file   ExampleAlgorithms/LArRotationalTransformationPlugin.h
 *
 *  @brief  Header file for the rotational transformation plugin class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_ROTATIONAL_TRANSFORMATION_PLUGIN_H
#define EXAMPLE_ROTATIONAL_TRANSFORMATION_PLUGIN_H 1
...
#endif // #ifndef EXAMPLE_ROTATIONAL_TRANSFORMATION_PLUGIN_H
