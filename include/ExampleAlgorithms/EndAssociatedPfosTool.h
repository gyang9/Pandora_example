/**
 *  @file   ExampleAlgorithms/EndAssociatedPfosTool.h
 * 
 *  @brief  Header file for the end associated pfos tool class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_END_ASSOCIATED_PFOS_TOOL_H
#define EXAMPLE_END_ASSOCIATED_PFOS_TOOL_H 1
...
#endif // #ifndef EXAMPLE_END_ASSOCIATED_PFOS_TOOL_H
