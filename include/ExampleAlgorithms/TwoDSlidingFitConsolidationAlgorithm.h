/**
 *  @file   ExampleAlgorithms/TwoDSlidingFitConsolidationAlgorithm.h
 *
 *  @brief  Header file for the 2D sliding fit consolidation algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TWO_D_SLIDING_FIT_CONSOLIDATION_ALGORITHM_H
#define EXAMPLE_TWO_D_SLIDING_FIT_CONSOLIDATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_TWO_D_SLIDING_FIT_CONSOLIDATION_ALGORITHM_H
