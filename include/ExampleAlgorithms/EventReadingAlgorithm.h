/**
 *  @file   ExampleAlgorithms/EventReadingAlgorithm.h
 * 
 *  @brief  Header file for the event reading algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_EVENT_READING_ALGORITHM_H
#define EXAMPLE_EVENT_READING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_EVENT_READING_ALGORITHM_H
