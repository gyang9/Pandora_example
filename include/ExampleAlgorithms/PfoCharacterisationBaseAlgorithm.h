/**
 *  @file   ExampleAlgorithms/PfoCharacterisationBaseAlgorithm.h
 * 
 *  @brief  Header file for the pfo characterisation base algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_PFO_CHARACTERISATION_BASE_ALGORITHM_H
#define EXAMPLE_PFO_CHARACTERISATION_BASE_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_PFO_CHARACTERISATION_BASE_ALGORITHM_H
