/**
 *  @file   ExampleAlgorithms/ThreeDBaseAlgorithm.h
 *
 *  @brief  Header file for the three dimension algorithm base class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_THREE_D_BASE_ALGORITHM_H
#define EXAMPLE_THREE_D_BASE_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_THREE_D_BASE_ALGORITHM_H
