/**
 *  @file   ExampleAlgorithms/MCParticleMonitoringAlgorithm.h
 *
 *  @brief  Header file for the mc particle monitoring algorithm.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_MC_PARTICLE_MONITORING_ALGORITHM_H
#define EXAMPLE_MC_PARTICLE_MONITORING_ALGORITHM_H 1
...
#endif // EXAMPLE_MC_PARTICLE_MONITORING_ALGORITHM_H
