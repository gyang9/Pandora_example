/**
 *  @file   ExampleAlgorithms/SlicingAlgorithm.h
 *
 *  @brief  Header file for the master algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_SLICING_ALGORITHM_H
#define EXAMPLE_SLICING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_SLICING_ALGORITHM_H
