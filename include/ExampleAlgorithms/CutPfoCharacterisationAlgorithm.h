/**
 *  @file   ExampleAlgorithms/CutPfoCharacterisationAlgorithm.h
 * 
 *  @brief  Header file for the cut based pfo characterisation algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_PFO_CHARACTERISATION_ALGORITHM_H
#define EXAMPLE_PFO_CHARACTERISATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_PFO_CHARACTERISATION_ALGORITHM_H
