/**
 *  @file   ExampleAlgorithms/TwoDSlidingFitSplittingAndSplicingAlgorithm.h
 *
 *  @brief  Header file for the two dimensional sliding fit splitting and splicing algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TWO_D_SLIDING_FIT_SPLITTING_AND_SPLICING_ALGORITHM_H
#define EXAMPLE_TWO_D_SLIDING_FIT_SPLITTING_AND_SPLICING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_TWO_D_SLIDING_FIT_SPLITTING_AND_SPLICING_ALGORITHM_H
