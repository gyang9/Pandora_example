/**
 *  @file   ExampleAlgorithms/DeltaRayIdentificationAlgorithm.h
 *
 *  @brief  Header file for the delta ray identification algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_DELTA_RAY_IDENTIFICATION_ALGORITHM_H
#define EXAMPLE_DELTA_RAY_IDENTIFICATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_DELTA_RAY_IDENTIFICATION_ALGORITHM_H
