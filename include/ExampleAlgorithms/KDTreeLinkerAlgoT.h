/**
 *  @file   examplepandoracontent/ExampleUtility/KDTreeLinkerAlgoT.h
 * 
 *  @brief  Header file for the kd tree linker algo template class
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_KD_TREE_LINKER_ALGO_TEMPLATED_H
#define EXAMPLE_KD_TREE_LINKER_ALGO_TEMPLATED_H
...
#endif // EXAMPLE_KD_TREE_LINKER_ALGO_TEMPLATED_H
