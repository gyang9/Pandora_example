/**
 *  @file   ExampleAlgorithms/ClusterMergingAlgorithm.h
 *
 *  @brief  Header file for the cluster merging algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_MERGING_ALGORITHM_H
#define EXAMPLE_CLUSTER_MERGING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CLUSTER_MERGING_ALGORITHM_H
