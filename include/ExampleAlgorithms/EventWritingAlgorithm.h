/**
 *  @file   ExampleAlgorithms/EventWritingAlgorithm.h
 * 
 *  @brief  Header file for the event writing algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_EVENT_WRITING_ALGORITHM_H
#define EXAMPLE_EVENT_WRITING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_EVENT_WRITING_ALGORITHM_H
