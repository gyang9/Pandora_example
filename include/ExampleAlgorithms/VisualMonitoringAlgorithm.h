/**
 *  @file   ExampleAlgorithms/VisualMonitoringAlgorithm.h
 * 
 *  @brief  Header file for the visual monitoring algorithm class
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_VISUAL_MONITORING_ALGORITHM_H
#define EXAMPLE_VISUAL_MONITORING_ALGORITHM_H 1
...
private:
    ...
    float                   m_scalingFactor;            ///< TEve works with [cm], Pandora usually works with [mm] (but ExampleContent went with cm too)
...
#endif // #ifndef EXAMPLE_VISUAL_MONITORING_ALGORITHM_H
