/**
 *  @file   ExampleAlgorithms/LArStitchingHelper.h
 *
 *  @brief  Header file for the helper class for multiple drift volumes.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_STITCHING_HELPER_H
#define EXAMPLE_STITCHING_HELPER_H 1
...
#endif // #ifndef EXAMPLE_STITCHING_HELPER_H
