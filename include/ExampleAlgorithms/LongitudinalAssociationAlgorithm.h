/**
 *  @file   ExampleAlgorithms/LongitudinalAssociationAlgorithm.h
 * 
 *  @brief  Header file for the longitudinal association algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_LONGITUDINAL_ASSOCIATION_ALGORITHM_H
#define EXAMPLE_LONGITUDINAL_ASSOCIATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_LONGITUDINAL_ASSOCIATION_ALGORITHM_H
