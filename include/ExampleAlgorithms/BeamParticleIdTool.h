/**
 *  @file   ExampleAlgorithms/BeamParticleIdTool.h
 *
 *  @brief  Header file for the beam particle id tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_BEAM_PARTICLE_ID_TOOL_H
#define EXAMPLE_BEAM_PARTICLE_ID_TOOL_H 1
...
#endif // #ifndef EXAMPLE_BEAM_PARTICLE_ID_TOOL_H
