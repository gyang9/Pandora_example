/**
 *  @file   ExampleAlgorithms/ThreeDHitCreationAlgorithm.h
 *
 *  @brief  Header file for the three dimensional hit creation algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_THREE_D_HIT_CREATION_ALGORITHM_H
#define EXAMPLE_THREE_D_HIT_CREATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_THREE_D_HIT_CREATION_ALGORITHM_H
