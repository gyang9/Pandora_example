/**
 *  @file   ExampleAlgorithms/CrossedTrackSplittingAlgorithm.h
 *
 *  @brief  Header file for the crossed track splitting algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CROSSED_TRACK_SPLITTING_ALGORITHM_H
#define EXAMPLE_CROSSED_TRACK_SPLITTING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CROSSED_TRACK_SPLITTING_ALGORITHM_H
