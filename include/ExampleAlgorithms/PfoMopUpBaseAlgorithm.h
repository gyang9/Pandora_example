/**
 *  @file   ExampleAlgorithms/PfoMopUpBaseAlgorithm.h
 * 
 *  @brief  Header file for the pfo mop up algorithm base class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_PFO_MOP_UP_BASE_ALGORITHM_H
#define EXAMPLE_PFO_MOP_UP_BASE_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_PFO_MOP_UP_BASE_ALGORITHM_H
