/**
 *  @file   ExampleAlgorithms/CosmicRayVertexBuildingAlgorithm.h
 *
 *  @brief  Header file for the cosmic-ray vertex building algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_COSMIC_RAY_VERTEX_BUILDING_ALGORITHM_H
#define EXAMPLE_COSMIC_RAY_VERTEX_BUILDING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_COSMIC_RAY_VERTEX_BUILDING_ALGORITHM_H
