/**
 *  @file   ExampleAlgorithms/CubeTwoDBaseMatchingAlgorithm.h
 *
 *  @brief  Header file for the cosmic ray base matching algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CUBE_TWOD_BASE_MATCHING_ALGORITHM_H
#define EXAMPLE_CUBE_TWOD_BASE_MATCHING_ALGORITHM_H 1
...
/**
 *  @brief  CubeTwoDBaseMatchingAlgorithm class
 */
class CubeTwoDBaseMatchingAlgorithm : public pandora::Algorithm
{
...
protected:
    ...
    virtual bool MatchClustersXY_XZ(const pandora::Cluster *const pCluster1, const pandora::Cluster *const pCluster2) const = 0;
    virtual bool MatchClustersXY_YZ(const pandora::Cluster *const pCluster1, const pandora::Cluster *const pCluster2) const = 0;
    virtual bool MatchClustersXZ_YZ(const pandora::Cluster *const pCluster1, const pandora::Cluster *const pCluster2) const = 0;
     ...
     */
    virtual void SetPfoParameters(const CubeTwoDBaseMatchingAlgorithm::Particle &protoParticle, 
...
private:
    ...
    void MatchClusters(const pandora::ClusterVector &clusterVector1, const pandora::ClusterVector &clusterVector2,
        CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters12) const;
    void MatchClustersXY_XZ(const pandora::ClusterVector &clusterVector1, const pandora::ClusterVector &clusterVector2,
        CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters12) const;
    void MatchClustersXY_YZ(const pandora::ClusterVector &clusterVector1, const pandora::ClusterVector &clusterVector2,
        CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters12) const;
    void MatchClustersXZ_YZ(const pandora::ClusterVector &clusterVector1, const pandora::ClusterVector &clusterVector2,
        CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters12) const;    
     ...
     */
    void MatchThreeViews(const CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters12,
        const CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters23,
        const CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters31,
     ...
     *  @param particleList the output list of particles
     */
    void MatchTwoViews(const CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters12,
        const CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters23,
        const CubeTwoDBaseMatchingAlgorithm::ClusterAssociationMap &matchedClusters31,
        ParticleList &particleList) const;
...
#endif // #ifndef EXAMPLE_COSMIC_RAY_BASE_MATCHING_ALGORITHM_H
