/**
 *  @file   ExampleAlgorithms/CosmicRayBaseMatchingAlgorithm.h
 *
 *  @brief  Header file for the cosmic ray base matching algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_COSMIC_RAY_BASE_MATCHING_ALGORITHM_H
#define EXAMPLE_COSMIC_RAY_BASE_MATCHING_ALGORITHM_H 1
