/**
 *  @file   ExampleAlgorithms/SvmVertexSelectionAlgorithm.h
 *
 *  @brief  Header file for the svm vertex selection algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_SVM_VERTEX_SELECTION_ALGORITHM_H
#define EXAMPLE_SVM_VERTEX_SELECTION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_SVM_VERTEX_SELECTION_ALGORITHM_H
