/**
 *  @file   ExampleAlgorithms/LArPointingCluster.h
 * 
 *  @brief  Header file for the lar pointing cluster class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_POINTING_CLUSTER_H
#define EXAMPLE_POINTING_CLUSTER_H 1
...
#endif // #ifndef EXAMPLE_POINTING_CLUSTER_H
