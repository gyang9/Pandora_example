/**
 *  @file   ExampleAlgorithms/BranchGrowingAlgorithm.h
 * 
 *  @brief  Header file for the branch growing algorithm base class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_BRANCH_GROWING_ALGORITHM_H
#define EXAMPLE_BRANCH_GROWING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_BRANCH_GROWING_ALGORITHM_H
