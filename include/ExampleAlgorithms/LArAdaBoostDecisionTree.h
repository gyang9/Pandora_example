/**
 *  @file   ExampleAlgorithms/LArAdaBoostDecisionTree.h
 *
 *  @brief  Header file for the lar adaptive boosted decision tree class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_ADABOOST_DECISION_TREE_H
#define EXAMPLE_ADABOOST_DECISION_TREE_H 1
...
#endif // #ifndef EXAMPLE_ADABOOST_DECISION_TREE_H
