/**
 *  @file   ExampleAlgorithms/CosmicRayTrackRecoveryAlgorithm.h
 *
 *  @brief  Header file for the cosmic ray longitudinal track recovery algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_COSMIC_RAY_TRACK_RECOVERY_ALGORITHM_H
#define EXAMPLE_COSMIC_RAY_TRACK_RECOVERY_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_COSMIC_RAY_TRACK_RECOVERY_ALGORITHM_H
