/**
 *  @file   ExampleAlgorithms/LArMonitoringHelper.h
 *
 *  @brief  Header file for the lar monitoring helper helper class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_MONITORING_HELPER_H
#define EXAMPLE_MONITORING_HELPER_H 1
...
#endif // #ifndef EXAMPLE_MONITORING_HELPER_H
