/**
 *  @file   ExampleAlgorithms/RPhiFeatureTool.h
 *
 *  @brief  Header file for the r/phi feature tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_RPHI_FEATURE_TOOL_H
#define EXAMPLE_RPHI_FEATURE_TOOL_H 1
...
#endif // #ifndef EXAMPLE_RPHI_FEATURE_TOOL_H
