/**
 *  @file   ExampleAlgorithms/LArTrackOverlapResult.h
 * 
 *  @brief  Header file for the lar track overlap result class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_TRACK_OVERLAP_RESULT_H
#define EXAMPLE_TRACK_OVERLAP_RESULT_H 1
...
#endif // #ifndef EXAMPLE_TRACK_OVERLAP_RESULT_H
