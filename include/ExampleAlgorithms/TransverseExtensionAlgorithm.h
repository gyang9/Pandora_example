/**
 *  @file   ExampleAlgorithms/TransverseExtensionAlgorithm.h
 *
 *  @brief  Header file for the transverse extension algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TRANSVERSE_EXTENSION_ALGORITHM_H
#define EXAMPLE_TRANSVERSE_EXTENSION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_TRANSVERSE_EXTENSION_ALGORITHM_H
