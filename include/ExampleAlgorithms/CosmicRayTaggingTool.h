/**
 *  @file   ExampleAlgorithms/CosmicRayTaggingTool.h
 *
 *  @brief  Header file for the cosmic-ray tagging tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_COSMIC_RAY_TAGGING_TOOL_H
#define EXAMPLE_COSMIC_RAY_TAGGING_TOOL_H 1
...
#endif // #ifndef EXAMPLE_COSMIC_RAY_TAGGING_TOOL_H
