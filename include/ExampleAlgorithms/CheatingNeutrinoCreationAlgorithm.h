/**
 *  @file   ExampleAlgorithms/CheatingNeutrinoCreationAlgorithm.h
 * 
 *  @brief  Header file for the cheating neutrino creation algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_CHEATING_NEUTRINO_CREATION_ALGORITHM_H
#define EXAMPLE_CHEATING_NEUTRINO_CREATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CHEATING_NEUTRINO_CREATION_ALGORITHM_H
