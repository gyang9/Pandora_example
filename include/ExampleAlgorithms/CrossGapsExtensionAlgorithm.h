/**
 *  @file   ExampleAlgorithms/CrossGapsExtensionAlgorithm.h
 *
 *  @brief  Header file for the cross gaps extension algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CROSS_GAPS_EXTENSION_ALGORITHM_H
#define EXAMPLE_GROSS_GAPS_EXTENSION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CROSS_GAPS_EXTENSION_ALGORITHM_H
