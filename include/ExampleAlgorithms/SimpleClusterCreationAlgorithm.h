/**
 *  @file   ExampleAlgorithms/SimpleClusterCreationAlgorithm.h
 *
 *  @brief  Header file for the cluster creation algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_SIMPLE_CLUSTER_CREATION_ALGORITHM_H
#define EXAMPLE_SIMPLE_CLUSTER_CREATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_SIMPLE_CLUSTER_CREATION_ALGORITHM_H
