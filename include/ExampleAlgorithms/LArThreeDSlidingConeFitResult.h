/**
 *  @file   ExampleAlgorithms/LArThreeDSlidingConeFitResult.h
 *
 *  @brief  Header file for the lar three dimensional sliding cone fit result class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_THREE_D_SLIDING_CONE_FIT_RESULT_H
#define EXAMPLE_THREE_D_SLIDING_CONE_FIT_RESULT_H 1
...
#endif // #ifndef EXAMPLE_THREE_D_SLIDING_CONE_FIT_RESULT_H
