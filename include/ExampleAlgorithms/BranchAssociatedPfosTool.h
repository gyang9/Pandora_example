/**
 *  @file   ExampleAlgorithms/BranchAssociatedPfosTool.h
 * 
 *  @brief  Header file for the branch associated pfos tool class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_BRANCH_ASSOCIATED_PFOS_TOOL_H
#define EXAMPLE_BRANCH_ASSOCIATED_PFOS_TOOL_H 1
...
#endif // #ifndef EXAMPLE_BRANCH_ASSOCIATED_PFOS_TOOL_H
