/**
 *  @file   ExampleAlgorithms/CheatingSliceIdBaseTool.h
 *
 *  @brief  Header file for the cheating slice id base tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CHEATING_SLICE_ID_BASE_TOOL_H
#define EXAMPLE_CHEATING_SLICE_ID_BASE_TOOL_H 1
...
#endif // #ifndef EXAMPLE_CHEATING_SLICE_ID_BASE_TOOL_H
