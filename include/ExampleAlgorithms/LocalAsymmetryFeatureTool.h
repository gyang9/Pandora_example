/**
 *  @file   ExampleAlgorithms/LocalAsymmetryFeatureTool.h
 *
 *  @brief  Header file for the local asymmetry feature tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_LOCAL_ASYMMETRY_FEATURE_TOOL_H
#define EXAMPLE_LOCAL_ASYMMETRY_FEATURE_TOOL_H 1
...
#endif // #ifndef EXAMPLE_LOCAL_ASYMMETRY_FEATURE_TOOL_H
