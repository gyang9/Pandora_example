/**
 *  @file   ExampleAlgorithms/PostProcessingAlgorithm.h
 * 
 *  @brief  Header file for the post processing algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_POST_PROCESSING_ALGORITHM_H
#define EXAMPLE_POST_PROCESSING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_POST_PROCESSING_ALGORITHM_H
