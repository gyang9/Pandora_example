/**
 *  @file   ExampleAlgorithms/CheatingCosmicRayShowerMatchingAlg.h
 * 
 *  @brief  Header file for the cosmic ray shower matching cheater class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_CHEATING_COSMIC_RAY_SHOWER_MATCHING_ALG_H
#define EXAMPLE_CHEATING_COSMIC_RAY_SHOWER_MATCHING_ALG_H 1
...
#endif // #ifndef EXAMPLE_CHEATING_COSMIC_RAY_SHOWER_MATCHING_ALG_H
