/**
 *  @file   ExampleAlgorithms/EnergyKickFeatureTool.h
 *
 *  @brief  Header file for the energy kick feature tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_ENERGY_KICK_FEATURE_TOOL_H
#define EXAMPLE_ENERGY_KICK_FEATURE_TOOL_H 1
...
#endif // #ifndef EXAMPLE_ENERGY_KICK_FEATURE_TOOL_H
