/**
 *  @file   ExampleAlgorithms/CheatingNeutrinoDaughterVerticesAlgorithm.h
 * 
 *  @brief  Header file for the cheating neutrino daughter vertices algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_CHEATING_NEUTRINO_DAUGHTER_VERTICES_ALGORITHM_H
#define EXAMPLE_CHEATING_NEUTRINO_DAUGHTER_VERTICES_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CHEATING_NEUTRINO_DAUGHTER_VERTICES_ALGORITHM_H
