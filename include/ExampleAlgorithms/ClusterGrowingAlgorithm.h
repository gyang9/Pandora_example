/**
 *  @file   ExampleAlgorithms/ClusterGrowingAlgorithm.h
 *
 *  @brief  Header file for the cluster growing algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_GROWING_ALGORITHM_H
#define EXAMPLE_CLUSTER_GROWING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CLUSTER_GROWING_ALGORITHM_H
