/**
 *  @file   ExampleAlgorithms/ClusterExtensionAlgorithm.h
 *
 *  @brief  Header file for the cluster extension algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_CLUSTER_EXTENSION_ALGORITHM_H
#define EXAMPLE_CLUSTER_EXTENSION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CLUSTER_EXTENSION_ALGORITHM_H
