/**
 *  @file   ExampleAlgorithms/LArFormatting.h
 *
 *  @brief  Header file for the formatting helper class
 *
 *  $Log: $
 */
#ifndef EXAMPLE_FORMATTING_HELPER_H
#define EXAMPLE_FORMATTING_HELPER_H 1
...
public:
    ...
    public:
         ...
         */
        template<typename T>
        void AddElement(const T &value, const Style style=REGUEXAMPLE, const Color color=DEFAULT);
...
#endif // #ifndef EXAMPLE_FORMATTING_HELPER_H
