 ...
 *  $Log: $
 */
#ifndef EXAMPLE_TRACK_CLUSTER_CREATION_ALGORITHM_H
#define EXAMPLE_TRACK_CLUSTER_CREATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_TRACK_CLUSTER_CREATION_ALGORITHM_H
