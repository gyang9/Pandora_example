/**
 *  @file   ExampleAlgorithms/EventSlicingTool.h
 *
 *  @brief  Header file for the event slicing tool class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_EVENT_SLICING_TOOL_H
#define EXAMPLE_EVENT_SLICING_TOOL_H 1
...
#endif // #ifndef EXAMPLE_EVENT_SLICING_TOOL_H
