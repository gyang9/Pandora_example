/**
 *  @file   ExampleAlgorithms/NeutrinoPropertiesAlgorithm.h
 *
 *  @brief  Header file for the neutrino properties algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_NEUTRINO_PROPERTIES_ALGORITHM_H
#define EXAMPLE_NEUTRINO_PROPERTIES_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_NEUTRINO_PROPERTIES_ALGORITHM_H
