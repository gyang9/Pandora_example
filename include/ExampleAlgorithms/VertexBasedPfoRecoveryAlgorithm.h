/**
 *  @file   ExampleAlgorithms/VertexBasedPfoRecoveryAlgorithm.h
 *
 *  @brief  Header file for the vertex-based particle recovery algorithm
 *
 *  $Log: $
 */
#ifndef EXAMPLE_VERTEX_BASED_PFO_RECOVERY_ALGORITHM_H
#define EXAMPLE_VERTEX_BASED_PFO_RECOVERY_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_VERTEX_BASED_PFO_RECOVERY_ALGORITHM_H
