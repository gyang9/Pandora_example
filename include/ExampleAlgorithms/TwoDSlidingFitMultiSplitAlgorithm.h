/**
 *  @file   ExampleAlgorithms/TwoDSlidingFitMultiSplitAlgorithm.h
 *
 *  @brief  Header file for the 2D sliding fit multi-split algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TWO_D_SLIDING_FIT_MULTI_SPLIT_ALGORITHM_H
#define EXAMPLE_TWO_D_SLIDING_FIT_MULTI_SPLIT_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_TWO_D_SLIDING_FIT_MULTI_SPLIT_ALGORITHM_H
