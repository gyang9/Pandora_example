/**
 *  @file   ExampleAlgorithms/LArInteractionTypeHelper.h
 *
 *  @brief  Header file for the interaction type helper class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_INTERACTION_TYPE_HELPER_H
#define EXAMPLE_INTERACTION_TYPE_HELPER_H 1
...
#endif // #ifndef EXAMPLE_INTERACTION_TYPE_HELPER_H
