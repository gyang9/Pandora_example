/**
 *  @file   ExampleAlgorithms/LArMCParticleHelper.h
 *
 *  @brief  Header file for the lar monte carlo particle helper helper class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_MC_PARTICLE_HELPER_H
#define EXAMPLE_MC_PARTICLE_HELPER_H 1
...
#endif // #ifndef EXAMPLE_MC_PARTICLE_HELPER_H
