/**
 *  @file   ExampleAlgorithms/VertexBasedPfoMopUpAlgorithm.h
 * 
 *  @brief  Header file for the vertex based pfo mop up algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_VERTEX_BASED_PFO_MOP_UP_ALGORITHM_H
#define EXAMPLE_VERTEX_BASED_PFO_MOP_UP_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_VERTEX_BASED_PFO_MOP_UP_ALGORITHM_H
