/**
 *  @file   ExampleAlgorithms/TransverseAssociationAlgorithm.h
 *
 *  @brief  Header file for the transverse association algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TRANSVERSE_ASSOCIATION_ALGORITHM_H
#define EXAMPLE_TRANSVERSE_ASSOCIATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_TRANSVERSE_ASSOCIATION_ALGORITHM_H
