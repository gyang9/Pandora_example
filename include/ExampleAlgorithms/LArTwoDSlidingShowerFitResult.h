/**
 *  @file   ExampleAlgorithms/LArTwoDSlidingShowerFitResult.h
 *
 *  @brief  Header file for the lar two dimensional sliding shower fit result class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_TWO_D_SLIDING_SHOWER_FIT_RESULT_H
#define EXAMPLE_TWO_D_SLIDING_SHOWER_FIT_RESULT_H 1
...
#endif // #ifndef EXAMPLE_TWO_D_SLIDING_SHOWER_FIT_RESULT_H
