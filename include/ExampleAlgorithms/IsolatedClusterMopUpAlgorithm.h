 ...
 *  $Log: $
 */
#ifndef EXAMPLE_ISOLATED_CLUSTER_MOP_UP_ALGORITHM_H
#define EXAMPLE_ISOLATED_CLUSTER_MOP_UP_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_ISOLATED_CLUSTER_MOP_UP_ALGORITHM_H
