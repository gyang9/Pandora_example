/**
 *  @file   ExampleAlgorithms/NeutrinoDaughterVerticesAlgorithm.h
 *
 *  @brief  Header file for the neutrino daughter vertices algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_NEUTRINO_DAUGHTER_VERTICES_ALGORITHM_H
#define EXAMPLE_NEUTRINO_DAUGHTER_VERTICES_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_NEUTRINO_DAUGHTER_VERTICES_ALGORITHM_H
