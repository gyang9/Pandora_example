/**
 *  @file   ExampleAlgorithms/CheatingPfoCreationAlgorithm.h
 * 
 *  @brief  Header file for the cheating cluster creation algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_CHEATING_PFO_CREATION_ALGORITHM_H
#define EXAMPLE_CHEATING_PFO_CREATION_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_CHEATING_PFO_CREATION_ALGORITHM_H
