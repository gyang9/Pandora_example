/**
 *  @file   ExampleAlgorithms/LArTwoDReco/ClusterSplitting/LayerSplittingAlgorithm.h
 *
 *  @brief  Header file for the layer splitting algorithm class.
 *
 *  $Log: $
 */
#ifndef EXAMPLE_LAYER_SPLITTING_ALGORITHM_H
#define EXAMPLE_LAYER_SPLITTING_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_LAYER_SPLITTING_ALGORITHM_H
