/**
 *  @file   ExampleAlgorithms/ParticleRecoveryAlgorithm.h
 * 
 *  @brief  Header file for the track recovery algorithm class.
 * 
 *  $Log: $
 */
#ifndef EXAMPLE_PARTICLE_RECOVERY_ALGORITHM_H
#define EXAMPLE_PARTICLE_RECOVERY_ALGORITHM_H 1
...
#endif // #ifndef EXAMPLE_PARTICLE_RECOVERY_ALGORITHM_H
