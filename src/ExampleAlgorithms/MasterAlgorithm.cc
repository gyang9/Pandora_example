/**
 *  @file   ExampleAlgorithms/MasterAlgorithm.cc
 *
...
#include "ExampleAlgorithms/LArFileHelper.h"
#include "ExampleAlgorithms/LArMCParticleHelper.h"
#include "ExampleAlgorithms/LArPfoHelper.h"

#include "ExampleAlgorithms/LArCaloHit.h"
#include "ExampleAlgorithms/LArMCParticle.h"

#include "ExampleAlgorithms/LArPseudoLayerPlugin.h"
#include "ExampleAlgorithms/LArRotationalTransformationPlugin.h"
...
const Pandora *MasterAlgorithm::CreateWorkerInstance(const LArTPC &larTPC, const DetectorGapList &gapList, const std::string &settingsFile, const std::string &name) const
{
    ...
    PANDORA_THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, ExampleContent::RegisterExampleAlgorithms(*pPandora));
    PANDORA_THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, ExampleContent::RegisterExamplePlugins(*pPandora));
    //PANDORA_THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, PandoraApi::SetPseudoLayerPlugin(*pPandora, new example_content::LArPseudoLayerPlugin));
    PANDORA_THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, PandoraApi::SetLArTransformationPlugin(*pPandora, new example_content::LArRotationalTransformationPlugin));
