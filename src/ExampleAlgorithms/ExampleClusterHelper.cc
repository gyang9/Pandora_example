/**
 *  @file   ExampleAlgorithms/ExampleClusterHelper.cc
 *
...
HitType ExampleClusterHelper::GetClusterHitType(const Cluster *const pCluster)
{
...
void ExampleClusterHelper::GetClustersUVW(const ClusterList &inputClusters, ClusterList &clusterListU, ClusterList &clusterListV, ClusterList &clusterListW)
{
    for (ClusterList::const_iterator iter = inputClusters.begin(), iterEnd = inputClusters.end(); iter != iterEnd; ++iter)
    {
        const HitType hitType(ExampleClusterHelper::GetClusterHitType(*iter));
...
void ExampleClusterHelper::GetClustersByHitType(const ClusterList &inputClusters, const HitType hitType, ClusterList &clusterList)
{
    for (ClusterList::const_iterator iter = inputClusters.begin(), iterEnd = inputClusters.end(); iter != iterEnd; ++iter)
    {
        if (hitType == ExampleClusterHelper::GetClusterHitType(*iter))
...
float ExampleClusterHelper::GetLengthSquared(const Cluster *const pCluster)
{
...
float ExampleClusterHelper::GetLength(const Cluster *const pCluster)
{
    return std::sqrt(ExampleClusterHelper::GetLengthSquared(pCluster));
}

//------------------------------------------------------------------------------------------------------------------------------------------

float ExampleClusterHelper::GetEnergyFromLength(const Cluster *const pCluster)
{
    const float dEdX(0.002f); // approximately 2 MeV/cm
    return (dEdX * ExampleClusterHelper::GetLength(pCluster));
}

//------------------------------------------------------------------------------------------------------------------------------------------

unsigned int ExampleClusterHelper::GetLayerSpan(const Cluster *const pCluster)
{
...
float ExampleClusterHelper::GetLayerOccupancy(const Cluster *const pCluster)
{
...
float ExampleClusterHelper::GetLayerOccupancy(const Cluster *const pCluster1, const Cluster *const pCluster2)
{
...
float ExampleClusterHelper::GetClosestDistance(const ClusterList &clusterList1, const ClusterList &clusterList2)
{
    ...
    for (ClusterList::const_iterator iter1 = clusterList1.begin(), iterEnd1 = clusterList1.end(); iter1 != iterEnd1; ++iter1)
    {
        ...
        const float thisDistance(ExampleClusterHelper::GetClosestDistance(pCluster1, clusterList2));
...
float ExampleClusterHelper::GetClosestDistance(const Cluster *const pCluster, const ClusterList &clusterList)
{
    ...
    for (ClusterList::const_iterator iter = clusterList.begin(), iterEnd = clusterList.end(); iter != iterEnd; ++iter)
    {
        ...
        const float thisDistance(ExampleClusterHelper::GetClosestDistance(pCluster, pTestCluster));
...
float ExampleClusterHelper::GetClosestDistance(const Cluster *const pCluster1, const Cluster *const pCluster2)
{
    CartesianVector closestPosition1(0.f, 0.f, 0.f);
    CartesianVector closestPosition2(0.f, 0.f, 0.f);

    ExampleClusterHelper::GetClosestPositions(pCluster1, pCluster2, closestPosition1, closestPosition2);
...
float ExampleClusterHelper::GetClosestDistance(const CartesianVector &position, const ClusterList &clusterList)
{
    return (position - ExampleClusterHelper::GetClosestPosition(position, clusterList)).GetMagnitude();
}

//------------------------------------------------------------------------------------------------------------------------------------------

float ExampleClusterHelper::GetClosestDistance(const CartesianVector &position, const Cluster *const pCluster)
{
    return (position - ExampleClusterHelper::GetClosestPosition(position, pCluster)).GetMagnitude();
}

//------------------------------------------------------------------------------------------------------------------------------------------

CartesianVector ExampleClusterHelper::GetClosestPosition(const CartesianVector &position, const ClusterList &clusterList)
{
    ...
    {
        const Cluster *const pTestCluster = *iter;
        const CartesianVector thisPosition(ExampleClusterHelper::GetClosestPosition(position, pTestCluster));
...
CartesianVector ExampleClusterHelper::GetClosestPosition(const CartesianVector &position, const Cluster *const pCluster)
{
    const OrderedCaloHitList &orderedCaloHitList(pCluster->GetOrderedCaloHitList());
...
void ExampleClusterHelper::GetClosestPositions(const Cluster *const pCluster1, const Cluster *const pCluster2, CartesianVector &outputPosition1, 
...
void ExampleClusterHelper::GetClusterBoundingBox(const Cluster *const pCluster, CartesianVector &minimumCoordinate, CartesianVector &maximumCoordinate)
{
    const OrderedCaloHitList &orderedCaloHitList(pCluster->GetOrderedCaloHitList());
...
void ExampleClusterHelper::GetClusterSpanX(const Cluster *const pCluster, float &xmin, float &xmax)
{
    const OrderedCaloHitList &orderedCaloHitList(pCluster->GetOrderedCaloHitList());
...
void ExampleClusterHelper::GetClusterSpanZ(const Cluster *const pCluster, const float xmin, const float xmax, 
...
StatusCode ExampleClusterHelper::GetAverageZ(const Cluster *const pCluster, const float xmin, const float xmax, float &averageZ)
{
...
void ExampleClusterHelper::GetExtremalCoordinates(const ClusterList &clusterList, CartesianVector &innerCoordinate, CartesianVector &outerCoordinate)
{
    ...
    return ExampleClusterHelper::GetExtremalCoordinates(orderedCaloHitList, innerCoordinate, outerCoordinate);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void ExampleClusterHelper::GetExtremalCoordinates(const Cluster *const pCluster, CartesianVector &innerCoordinate, CartesianVector &outerCoordinate)
{
  return ExampleClusterHelper::GetExtremalCoordinates(pCluster->GetOrderedCaloHitList(), innerCoordinate, outerCoordinate);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void ExampleClusterHelper::GetExtremalCoordinates(const OrderedCaloHitList &orderedCaloHitList, CartesianVector &innerCoordinate,
    CartesianVector &outerCoordinate)
{
    ...
    std::sort(coordinateVector.begin(), coordinateVector.end(), ExampleClusterHelper::SortCoordinatesByPosition);
    return ExampleClusterHelper::GetExtremalCoordinates(coordinateVector, innerCoordinate, outerCoordinate);
}

//------------------------------------------------------------------------------------------------------------------------------------------

void ExampleClusterHelper::GetExtremalCoordinates(const CartesianPointVector &coordinateVector, CartesianVector &innerCoordinate,
    CartesianVector &outerCoordinate)
{
...
void ExampleClusterHelper::GetCoordinateVector(const Cluster *const pCluster, CartesianPointVector &coordinateVector)
{
...
bool ExampleClusterHelper::SortByNOccupiedLayers(const Cluster *const pLhs, const Cluster *const pRhs)
{
...
bool ExampleClusterHelper::SortByNHits(const Cluster *const pLhs, const Cluster *const pRhs)
{
...
bool ExampleClusterHelper::SortByLayerSpan(const Cluster *const pLhs, const Cluster *const pRhs)
{
...
bool ExampleClusterHelper::SortByInnerLayer(const Cluster *const pLhs, const Cluster *const pRhs)
{
...
bool ExampleClusterHelper::SortByPosition(const Cluster *const pLhs, const Cluster *const pRhs)
{
...
bool ExampleClusterHelper::SortByPulseHeight(const Cluster *const pLhs, const Cluster *const pRhs)
{
...
bool ExampleClusterHelper::SortHitsByPosition(const CaloHit *const pLhs, const CaloHit *const pRhs)
{
...
bool ExampleClusterHelper::SortHitsByPulseHeight(const CaloHit *const pLhs, const CaloHit *const pRhs)
{
...
bool ExampleClusterHelper::SortCoordinatesByPosition(const CartesianVector &lhs, const CartesianVector &rhs)
{
