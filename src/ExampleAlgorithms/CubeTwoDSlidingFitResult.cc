/**
 *  @file   ExampleAlgorithms/CubeTwoDSlidingFitResult.cc
 *
    ...
    m_orthoDirection(0.f, 0.f, 0.f)
{
    ...
    CubeClusterHelper::GetCoordinateVector(pCluster, pointVector);
...
void TwoDSlidingFitResult::CalculateAxes(const CartesianPointVector &coordinateVector, const float layerPitch)
{
    ...
    CubePcaHelper::RunPca(coordinateVector, centroid, eigenValues, eigenVecs);
