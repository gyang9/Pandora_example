/**
 *  @file   ExampleAlgorithms/CubeTwoDTrackMatchingAlgorithm.cc
 *
...
CubeTwoDTrackMatchingAlgorithm::CubeTwoDTrackMatchingAlgorithm() :
...
void CubeTwoDTrackMatchingAlgorithm::SelectCleanClusters(const ClusterVector &inputVector, ClusterVector &outputVector) const
{
    ...
    {
        if (CubeClusterHelper::GetLengthSquared(pCluster) < m_clusterMinLength * m_clusterMinLength)
            continue;
    ...
    {
        const float lengthSquared(CubeClusterHelper::GetLengthSquared(pCluster));
        CartesianVector innerVertex(0.f,0.f,0.f), outerVertex(0.f,0.f,0.f);
        CubeClusterHelper::GetExtremalCoordinates(pCluster, innerVertex, outerVertex);
        ...
        for (const Cluster *const pClusterCheck : clusterVector)
        {
            ...
            if ((CubeClusterHelper::GetLengthSquared(pClusterCheck) > 10.f * lengthSquared) &&
                (CubeClusterHelper::GetClosestDistance(innerVertex, pClusterCheck) < m_vtxXOverlap ||
                 CubeClusterHelper::GetClosestDistance(outerVertex, pClusterCheck) < m_vtxXOverlap))
            {
                isDeltaRay = true;
                break;
            }
...
bool CubeTwoDTrackMatchingAlgorithm::MatchClusters(const Cluster *const pCluster1, const Cluster *const pCluster2) const
{
    ...
    CubeClusterHelper::GetExtremalCoordinates(pCluster1, innerVertex1, outerVertex1);
    CubeClusterHelper::GetExtremalCoordinates(pCluster2, innerVertex2, outerVertex2);
    ...
    CubeClusterHelper::GetClusterSpanX(pCluster1, xMin1, xMax1);
    CubeClusterHelper::GetClusterSpanX(pCluster2, xMin2, xMax2);
...
bool CubeTwoDTrackMatchingAlgorithm::MatchClustersXY_XZ(const Cluster *const pCluster1, const Cluster *const pCluster2) const
{
    // Use start and end points
    CartesianVector innerVertex1(0.f,0.f,0.f), outerVertex1(0.f,0.f,0.f);
    CartesianVector innerVertex2(0.f,0.f,0.f), outerVertex2(0.f,0.f,0.f);
...
bool CubeTwoDTrackMatchingAlgorithm::MatchClustersXY_YZ(const Cluster *const pCluster1, const Cluster *const pCluster2) const
{
    // Use start and end points
    CartesianVector innerVertex1(0.f,0.f,0.f), outerVertex1(0.f,0.f,0.f);
    CartesianVector innerVertex2(0.f,0.f,0.f), outerVertex2(0.f,0.f,0.f);
    ...
    CubeClusterHelper::GetClusterSpanZ(pCluster1, yMin1, yMax1);
    CubeClusterHelper::GetClusterSpanX(pCluster2, yMin2, yMax2);
...
bool CubeTwoDTrackMatchingAlgorithm::MatchClustersXZ_YZ(const Cluster *const pCluster1, const Cluster *const pCluster2) const
{
    // Use start and end points
    CartesianVector innerVertex1(0.f,0.f,0.f), outerVertex1(0.f,0.f,0.f);
    CartesianVector innerVertex2(0.f,0.f,0.f), outerVertex2(0.f,0.f,0.f);
    ...
    CubeClusterHelper::GetClusterSpanZ(pCluster1, zMin1, zMax1);
    CubeClusterHelper::GetClusterSpanZ(pCluster2, zMin2, zMax2);
...
bool CubeTwoDTrackMatchingAlgorithm::CheckMatchedClusters3D(const Cluster *const pCluster1, const Cluster *const pCluster2,
...
/*
    ...
    CubeClusterHelper::GetExtremalCoordinates(pCluster1, innerVertex1, outerVertex1);
    CubeClusterHelper::GetExtremalCoordinates(pCluster2, innerVertex2, outerVertex2);
    CubeClusterHelper::GetExtremalCoordinates(pCluster3, innerVertex3, outerVertex3);
    ...
    for (unsigned int n = 0; n < 4; ++n)
    {
            ...
            std::fabs(end3.GetX() - end1.GetX()) < std::max(m_vtxXOverlap, std::fabs(end3.GetX() - vtx1.GetX())))
        {
            ...
            CubeGeometryHelper::MergeTwoPositions(this->GetPandora(), hitType1, hitType2, vtx1, vtx2, projVtx3, chi2);
            CubeGeometryHelper::MergeTwoPositions(this->GetPandora(), hitType1, hitType2, end1, end2, projEnd3, chi2);
            CubeGeometryHelper::MergeTwoPositions(this->GetPandora(), hitType2, hitType3, vtx2, vtx3, projVtx1, chi2);
            CubeGeometryHelper::MergeTwoPositions(this->GetPandora(), hitType2, hitType3, end2, end3, projEnd1, chi2);
            CubeGeometryHelper::MergeTwoPositions(this->GetPandora(), hitType3, hitType1, vtx3, vtx1, projVtx2, chi2);
            CubeGeometryHelper::MergeTwoPositions(this->GetPandora(), hitType3, hitType1, end3, end1, projEnd2, chi2);

            const bool matchedVtx1(CubeClusterHelper::GetClosestDistance(projVtx1, pCluster1) < m_maxDisplacement);
            const bool matchedVtx2(CubeClusterHelper::GetClosestDistance(projVtx2, pCluster2) < m_maxDisplacement);
            const bool matchedVtx3(CubeClusterHelper::GetClosestDistance(projVtx3, pCluster3) < m_maxDisplacement);

            const bool matchedEnd1(CubeClusterHelper::GetClosestDistance(projEnd1, pCluster1) < m_maxDisplacement);
            const bool matchedEnd2(CubeClusterHelper::GetClosestDistance(projEnd2, pCluster2) < m_maxDisplacement);
            const bool matchedEnd3(CubeClusterHelper::GetClosestDistance(projEnd3, pCluster3) < m_maxDisplacement);
...
void CubeTwoDTrackMatchingAlgorithm::SetPfoParameters(const Particle &particle, PandoraContentApi::ParticleFlowObject::Parameters &pfoParameters) const
{
...
StatusCode CubeTwoDTrackMatchingAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
    ...
    return CubeTwoDBaseMatchingAlgorithm::ReadSettings(xmlHandle);
}
