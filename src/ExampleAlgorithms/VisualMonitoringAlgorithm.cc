/**
 *  @file   ExampleAlgorithms/VisualMonitoringAlgorithm.cc
 * 
...
//    m_thresholdEnergy(0.f),
//    m_transparencyThresholdE(0.f),
//    m_energyScaleThresholdE(0.f),
...
void VisualMonitoringAlgorithm::VisualizeClusterList(const std::string &listName) const
{
    ...
    std::cout<<"starting the VisualMonitoringAlgorithm::VisualizeClusterList"<<std::endl;
    ...
    std::cout<<"pre-processing of  VisualMonitoringAlgorithm::VisualizeClusterList  done."<<std::endl;
    ...
    std::cout<<"filtered of  VisualMonitoringAlgorithm::VisualizeClusterList"<<std::endl;
