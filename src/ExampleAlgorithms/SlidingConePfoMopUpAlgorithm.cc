/**
 *  @file   ExampleAlgorithms/SlidingConePfoMopUpAlgorithm.cc
 * 
...
#include "ExampleAlgorithms/LArThreeDSlidingConeFitResult.h"

#include "ExampleAlgorithms/SlidingConePfoMopUpAlgorithm.h"
