/**
 *  @file   ExampleAlgorithms/EnergyKickVertexSelectionAlgorithm.cc
 *
...
#include "ExampleAlgorithms/EnergyKickVertexSelectionAlgorithm.h"
...
StatusCode EnergyKickVertexSelectionAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
    ...
    {
        std::cout << "EnergyKickVertexSelection: Invalid parameter(s), Epsilon " << m_epsilon << ", AsymmetryConstant " << m_asymmetryConstant << std::endl;
