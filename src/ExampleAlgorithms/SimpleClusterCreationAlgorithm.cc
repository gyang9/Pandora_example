/**
 *  @file   ExampleAlgorithms/SimpleClusterCreationAlgorithm.cc
 *
...
StatusCode SimpleClusterCreationAlgorithm::Run()
{
    ...
    //PANDORA_THROW_RESULT_IF(STATUS_CODE_SUCCESS, !=, PandoraContentApi::SaveList<Cluster>(*this, m_outputListName));
